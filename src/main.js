...
const securitymCodeMasked = IMask(securityCode, segurityCodePattern)
...
securitymCodeMasked.on("accept", () => {

  updateSecurityCode(securitymCodeMasked.value)
})
...
carNumberMasked.on("accept",() =>{
    ...
    updateCard(carNumberMasked.value)
})
